...
(function (g) {
  ...
  var ALL = ['volley', 'wave', 'dash', 'mortar', 'ring', 'slam', 'mines', 'wall', 'dive', 'swing', 'swoop',
    'pincer', 'cannon', 'clawrush', 'quake', 'geyser', 'crescent', 'leapslash', 'rain', 'needles', 'arcbolt',
    'breath', 'eruption', 'tackle', 'bite', 'voidstep', 'crossorb', 'voidring', 'tailbeam',
    'hornflip', 'stomp', 'anvil', 'sawrush', 'sawtoss', 'embers', 'crownbeam', 'barrage', 'tailspin', 'pounce'];
  ...
  var roster = [
    ...
    },
    {
      ...
      routine: [
        ...
        { move: 'crescent',  from: 'mid',  rest: .85 },
        { move: 'leapslash', from: 'mid',  rest: 1 },
        { move: 'rain',      from: 'far',  rest: .9 },
        { move: 'crescent',  from: 'far',  rest: .85 }
      ], tempo: 1.05,
    ...
    },
    {
      ...
      blurb: '宙を飛ぶ蜂。尾から毒針を撃ち、雷を三点に落とし、低く滑空して突っ込む。降りてくるのは毒針で急降下した時だけ。',
      ...
      routine: [
        { move: 'needles', from: 'far',  rest: .75 },
        { move: 'arcbolt', from: 'mid',  rest: .8 },
        { move: 'swoop',   from: 'far',  rest: .9 },
        { move: 'needles', from: 'mid',  rest: .75 },
    ...
    },
    {
      ...
      blurb: '虚ろな蠍。消えて背後に回り尾で刺し、割れる虚空弾と二重の輪、床を這う尾の光線で押してくる。装甲は薄い。',
      ...
      routine: [
        { move: 'crossorb', from: 'mid',  rest: .7 },
        { move: 'voidstep', from: 'near', rest: .65 },
        { move: 'voidring', from: 'far',  rest: .7 },
        { move: 'tailbeam', from: 'far',  rest: .6 },
        { move: 'voidstep', from: 'mid',  rest: .8 }
      ], tempo: .72,
    ...
    },
    {
      ...
      blurb: '丸鋸の蜘蛛。小さくて速い。丸鋸で床を駆け、戻ってくる丸鋸を投げ、背の煙突から火の粉を降らせ、天井の糸で振り子のように横切る。',
      ...
      routine: [
        { move: 'sawrush', from: 'far',  rest: .65 },
        { move: 'sawtoss', from: 'mid',  rest: .7 },
        { move: 'embers',  from: 'mid',  rest: .6 },
        { move: 'swing',   from: 'far',  rest: .75 },
        { move: 'sawtoss', from: 'far',  rest: .7 },
        { move: 'embers',  from: 'far',  rest: .65 }
      ], tempo: .65,
    ...
    },
    {
      ...
      blurb: '最後の門を守る機竜。背の砲で頭の高さと足元を二段に薙ぎ、上下に撃ち分け、尾を回して飛びかかる。休みも短い。',
      ...
      routine: [
        { move: 'barrage',   from: 'far',  rest: .7 },
        { move: 'crownbeam', from: 'far',  rest: .65 },
        { move: 'tailspin',  from: 'near', rest: .8 },
        { move: 'pounce',    from: 'mid',  rest: .75 },
        { move: 'barrage',   from: 'far',  rest: .7 },
        { move: 'crownbeam', from: 'mid',  rest: .85 }
      ], tempo: .8,
