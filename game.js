(function (global) {
  ...
  NeonGame.prototype._boss=function(dt){
    ...
    if(!b.phaseOut&&hit(p,b)&&p.invuln<=0){p.hp-=2;if(this._registerHit)this._registerHit();p.invuln=1;s.shake=.3;if(p.hp<=0)this._die();}
  };
