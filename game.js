(function (global) {
  ...
  combat.rising = { span: .62, crouch: .08, lift: 354, gravity: 680, drift: 34, apex: 92 };
  ...
  combat.saberHitTimes = [[.16], [.08], [.13, .17, .21, .25], [.14, .27, .40, .53]];
