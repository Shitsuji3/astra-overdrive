...
公開確認（2026-09-23）：ジャストダッシュをPR #3でmainへマージ（9dc480f）。Actions 35876610971 success。公開URLでボス戦中に成立（HP8/8、演出表示）を確認、起動18・パッド29・マウス11成功、エラー0。

## 修正：画面を閉じても音が鳴る（2026-09-24、Opus 5.5）
