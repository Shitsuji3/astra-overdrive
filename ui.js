...
function guide(){modalReturn=document.activeElement;modal.hidden=false;$('#modal-content').innerHTML='<div class="eyebrow">PILOT MANUAL</div><h2>操作ガイド</h2><table class="guide-table"><tr><th>操作</th><th>キーボード</th><th>ゲームパッド</th></tr><tr><td>移動</td><td>A / D　← / →</td><td>左スティック</td></tr><tr><td>ジャンプ</td><td>Space / Z</td><td>A</td></tr><tr><td>ダッシュ</td><td>Shift / X</td><td>B</td></tr><tr><td>射撃</td><td>J 長押し→離してチャージ</td><td>X</td></tr><tr><td>セイバー</td><td>K または右クリック</td><td>Y</td></tr><tr><td>斬り上げ</td><td>↑ / W ＋ セイバー</td><td>上 ＋ Y</td></tr><tr><td>壁蹴り</td><td>壁につかまり＋ジャンプ</td><td>壁際＋A</td></tr></table><p>ESC / P　ポーズ</p>'}
...
// START MISSION agree with the last thing that was looked at.
